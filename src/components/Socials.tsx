...
const Socials = () => {
  return (
    <div className="fixed top-4 right-4 z-50 flex gap-3 sm:gap-4 md:gap-6">
      ...
      >
        <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center border-2 border-black/20 group-hover:from-blue-300 group-hover:to-blue-500 transition-all duration-300 overflow-hidden">
          <img 
